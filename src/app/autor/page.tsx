...
export const metadata: Metadata = {
  title: "Junior Cristovam | Autor",
  description:
    "Conheça Junior Cristovam, autor de O Castelo das Marias, romance que une drama psicológico, fantasia e mistério sobrenatural.",
  openGraph: {
    title: "Junior Cristovam | Autor de O Castelo das Marias",
    description:
      "Escritor brasileiro de fantasia e autor do romance O Castelo das Marias.",
    images: [
      {
        url: "/autor.webp",
        width: 800,
        height: 800,
        alt: "Junior Cristovam",
      },
    ],
  },
};
...
export default function AutorPage() {
  return (
    <div className="container-fluid page-author">
      ...
      <figure className="author-figure">
        <picture>
          <source srcSet="/autor.webp" type="image/webp" />
          <img
            src="/autor.webp"
